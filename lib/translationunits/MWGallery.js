...
MWGallery.prototype.adapt = cxutil.async( function*() {
	var imageItems, imageTitle, namespaceAlias, imageCaptionWikitext, requestManager,
	...
	for ( let i = 0; i < imageItems.length; i++ ) {
		...
		namespaceAlias = yield requestManager.getNamespaceAlias( 'File', this.targetLanguage );
