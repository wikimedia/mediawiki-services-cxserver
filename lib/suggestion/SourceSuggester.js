...
class SourceSuggester {
	 ...
	 * @param {Object} config
	 * @cfg {string[]} sourceLanguages Array of possible source languages
	 * @cfg {MWApiRequestManager} api The api manager instance
	 * @cfg {Object} context The application context
	 * @cfg {Function} mtProviderFactory A function that returns a valid MTClient instance
	 */
